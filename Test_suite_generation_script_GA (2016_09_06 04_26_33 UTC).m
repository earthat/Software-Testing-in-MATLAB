function [genetic_test_set] = Test_suite_generation_script_GA(fn_name, no_variables)
...
[Genetic_test_case,index] =geneticTestFind(no_variables,mutepath,mute_ids{m});
